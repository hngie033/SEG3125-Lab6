...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        var firstThing = readData("firstThing");
        var login = readData("login");
        var freq = readData("freq");
        var interests = readData("interests");
        var represent = readData("represent");
        var comments = readData("comments");
        res.render('showResults', {results: [firstThing, login, freq, interests, represent, comments]});
        console.log([firstThing, login, freq, interests, represent, comments]);
    });
